...
// ================= STATS PERSONNELS PAR SERVICE =================

const statsPersonnelsParService = useMemo(()=>{

const groups:Record<string,number> = {}

personnels.forEach((p)=>{

const service = p.service?.nomService || "Non défini"
...
XLSX.writeFile(workbook, "personnels_par_service.xlsx")
...
pdf.save("personnels_par_service.pdf")
...
<BarChart data={statsPersonnelsParService}>
...
export default PersonnelParService3