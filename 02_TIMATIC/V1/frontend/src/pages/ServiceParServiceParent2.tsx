...
const filteredServices = useMemo(()=>{
  return services.filter((s)=>{
    ...
    const matchParent =
      selectedParent === "all" ||
      String(s.serviceParentId) === selectedParent
    return matchSearch && matchParent
  })
},[services,search,selectedParent])
  ...
  try {
    const res = await axios.get("http://localhost:5000/api/service-parents")
    setServiceParents(res.data)
  } catch {
    console.error("Erreur chargement service parents")
  }
}
//
          ...
          <div className="container mx-auto max-w-6xl space-y-12" ref={exportRef}>
            ...
            <div className="flex gap-4 justify-center">
                ...
                >
                    ...
                    <SelectValue placeholder="Filtrer par service parent"/>
                    </SelectTrigger>
                    <SelectContent>
                    <SelectItem value="all">
                        Tous les services parents
                    </SelectItem>
