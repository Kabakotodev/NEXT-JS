...
const Document = () => {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      notifyError("Impossible de charger les documents");
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.nomDocument || !formData.sigleDocument) {
      notifyWarning("Nom et Sigle sont obligatoires");
      return;
    }
    ...
    try {
      if (editingId) {
        ...
        notifySuccess("Document modifié avec succès");
      } else {
              ...
              <table className="w-full text-sm border-collapse text-center">
                <thead>
                  <tr className="border-b">
                    <th className="text-center p-3 font-semibold">NOM</th>
                    <th className="text-center p-3 font-semibold">SIGLE</th>
                    <th className="text-center p-3 font-semibold">DESCRIPTION</th>
