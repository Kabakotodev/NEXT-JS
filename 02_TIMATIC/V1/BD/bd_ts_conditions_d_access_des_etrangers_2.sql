...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 25 fév. 2026 à 00:58
...
--
-- Base de données : `bd_ts_conditions_d_access_des_etrangers_2`
--
...
INSERT INTO `regime` (`id`, `nomRegime`, `descRegime`, `objetRegime`, `nationaliteId`) VALUES
(1, 'Exemption Visa CEDEAO', 'Libre circulation', 'Les ressortissants CEDEAO sont exemptés.', 1),
(2, 'Visa obligatoire USA', 'Visa requis', 'Visa obligatoire avant entrée.', 50),
(3, 'Dispense de visa', 'Document non soumis au visa', 'Le titulaire de ce document n\'est pas soumis au visa. \nIl est admins a pénétrer sur le territoire sénégalais sur présentation:\n - d\'un passeport en cours de validité,\n - d\'une garantie de rapatriement, d\'un billet aller-retour ou d\'un titre de voyage pour une destination extérieure du Sénégal,\n - d\'un certificat international de vaccination exigé par les règlements sanitaires', 27);
...
('e983cdcf-ae02-43eb-89e0-b6d6846a3b07', '04733c1193097936a3f7c015c768b60306a60da2930301a2bb894a98977499e4', '2026-02-24 23:19:52.111', '20260224231951_update_regime_m2m', NULL, NULL, '2026-02-24 23:19:51.715', 1);
